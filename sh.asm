...
;   0x1280  hint   "commands: help echo count regs exit"
;   0x12B0  "cpuj: unknown command '"
;   0x12D0  "'\n"
...
main:
    ...
    MOVI R1, #0x1280        ; "commands: help echo count regs exit"
    MOVI R0, #0x63  ; c
    CALL @putc
    MOVI R0, #0x6F  ; o
    CALL @putc
    ...
    MOVI R1, #0x12B0        ; "cpuj: unknown command '"
    MOVI R0, #0x63  ; c
    CALL @putc
    MOVI R0, #0x70  ; p
    CALL @putc
